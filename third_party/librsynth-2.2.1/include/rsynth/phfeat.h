...
/* ugly, but useful for auto-extraction --mocoow */
#define Fnames {"alv","apr","bck","blb","cnt","dnt","fnt","frc", "glt","hgh","lat","lbd","lbv","lmd","low","mdl", "nas","pal","pla","rnd","rzd","smh","stp","umd", "unr","vcd","vel","vls","vwl",NULL}
